	...
	function update_page_data(page){
     	...
     	var manifesto_sound;
     		...
     		if( page == 4 || page == 5 || page == 11 || page == 18 || page == 19 || page == 37 || page == 38 || page == 58  || page ==73 || page ==74|| page ==79|| page ==80){
     			...
     			manifesto_pdf = "The undecided manifesto";
     			manifesto_sound = "http://localhost/mani/wp-content/uploads/2018/02/theundecided.mp3";
     		}

     		if(page == 6 || page == 7){
     			manifesto_title = "Raw Manifesto";
     			manifesto_pdf = "Raw Manifesto";
     			manifesto_sound = "http://localhost/mani/wp-content/uploads/2018/02/raw.mp3";
     		}

     		if(page == 8 || page == 9 || page == 10){
     			manifesto_title = "The stage, things and no body manifesto";
     			manifesto_pdf = "The stage, things and no body manifesto";
     			manifesto_sound= "";
     		}
     		...
     		document.getElementById("infoSection").setAttribute( "onClick", "printJS("+manifesto_pdf+")" );

     		var source = document.getElementById("audio");
     		source.src = manifesto_sound;
